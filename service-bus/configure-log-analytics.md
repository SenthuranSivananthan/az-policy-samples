...
* [Azure Service Bus Data Owner](https://docs.microsoft.com/en-us/azure/role-based-access-control/built-in-roles#azure-service-bus-data-owner)
...
* At a management group where both Service Bus and Log Analytics can inherit the Managed Service Identity; or
